...
class User extends Model
{
    ...
    {
        return $this->hasOne(Rank::class, "r_index_num", "s_index_num")->withDefault(function () {
            return new Rank();
        });
    }
    ...
    {
        return $this->hasOne(Trade::class, "t_code", "s_trade_code")->where('is_active', 1)->withDefault(function () {
            return new Trade();
        });
    }
    ...
    {
        return $this->hasOne(Institute::class, "i_code", "s_inst_code")->where('is_active', 1)->withDefault(function () {
