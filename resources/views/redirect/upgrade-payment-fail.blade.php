...
$other = "COUNSELLINGUPGRADEFEES_$user_id";
$marid = '5';
$merchant_order_num = $orderid;
$total_amount = env('COUNSELLING_UPGRADE_FEES');
$marchant_id = env('SBI_MERCHANT_ID');
$requestParameter = "{$marchant_id}|DOM|IN|INR|$total_amount|$other|$success_url|$fail_url|SBIEPAY|$merchant_order_num|$marid|NB|ONLINE|ONLINE";
...
<body>
    <div class="card">
        ...
        <br />
        <a href="{{ env('REDIRECT_ALLOTMENT_PAGE') }}" style="text-decoration: none;">Go To Allotment Page</a>
        <br />
        <br />
